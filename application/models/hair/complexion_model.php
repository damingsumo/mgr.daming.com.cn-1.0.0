<?php
class Complexion_model extends MY_Model{

    protected $tableName = "complexion";
    protected $primaryKey = 'complexion_id';
     ...
     * @return number
     */
    public function getComplexionCountByParams($params) {
